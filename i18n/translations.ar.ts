...
export const TRANSLATIONS_AR = {
  ...
  about: {
    ...
    storyTitle: 'قصتنا',
    storyP1: 'تأسست شركة "Metaline" من شغف بالجمالية والعملية في عالم البناء. ما بدأ كورشة صغيرة grew لتصبح واحدة من الشركات الرائدة في حلول الألومنيوم والصلب للاستخدام السكني والصناعي.',
