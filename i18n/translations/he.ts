...
export const he = {
  ...
  tagline: "מסגריה אומנותית · שערים, גדרות, מעקות, פרגולות וסורגים",
  nav: [
    { path: '/', label: 'בית' },
  ...
  home: {
    heroTitle: 'מסגריה אומנותית',
    heroHighlight: 'ברמה הגבוהה ביותר',
    heroDesc: 'תכנון, ייצור והתקנה של שערים חשמליים, גדרות, פרגולות, מעקות וסורגים — מאלומיניום ופלדה, מותאם אישית לבית ולעסק.',
    servicesTitle: 'עבודות מסגרות',
    servicesDesc: 'מסגריה מקצועית עם מעל 20 שנות ניסיון. כל מוצר מיוצר בקפדנות בבית המלאכה שלנו בחולון.',
    ctaTitle: 'מחפשים מסגר מקצועי?',
    ctaDesc: 'הצוות שלנו זמין לייעוץ, מדידה והצעת מחיר — בלי התחייבות. בואו נתכנן יחד את הפרויקט שלכם.',
  ...
  about: {
    ...
    storyP1: 'חברת "Metaline" הוקמה מתוך תשוקה לאסתטיקה ופרקטיקה בעולם הבנייה. מה שהתחיל כבית מלאכה קטן, צמח להיות אחת החברות המובילות בתחום פתרונות האלומיניום והפלדה למגורים ולתעשייה.',
