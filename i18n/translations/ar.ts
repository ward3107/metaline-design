 ...
 * Matches the Hebrew translation structure for full integration
 */
export const ar = {
  direction: 'rtl' as const,
  companyName: "Metaline",
  tagline: "أعمال حدادة مخصصة · بوابات، أسوار، درابزين، مظلات وقضبان",
  nav: [
    { path: '/', label: 'الرئيسية' },
  ...
  home: {
    heroTitle: 'أعمال حدادة',
    heroHighlight: 'بأعلى مستوى',
    heroDesc: 'تصميم وتصنيع وتركيب البوابات الكهربائية والأسوار والمظلات والدرابزين والقضبان — من الألومنيوم والصلب، حسب الطلب للمنازل والشركات.',
    servicesTitle: 'أعمالنا الحدادية',
    servicesDesc: 'ورشة حدادة مهنية مع أكثر من 20 عاماً من الخبرة. كل قطعة مصنوعة بعناية في ورشتنا في حولون.',
    ctaTitle: 'تبحثون عن حداد محترف؟',
    ctaDesc: 'فريقنا متاح للاستشارة والقياس وعرض السعر — بدون التزام. لنخطط لمشروعكم معاً.',
  ...
  about: {
    ...
    storyTitle: 'قصتنا',
    storyP1: 'تأسست شركة "Metaline" من شغف بالجمالية والعملية في عالم البناء. ما بدأ كورشة صغيرة أصبح واحدة من الشركات الرائدة في حلول الألومنيوم والصلب للاستخدام السكني والصناعي.',
  ...
  productsList: [
    ...
    { id: '3', category: 'fences', title: 'سيارة Louvers', description: 'سيارة ألومنيوم موديل Louvers للخصوصية الكاملة', image: 'https://picsum.photos/600/400?random=12' },
