...
export const ar = {
  ...
  about: {
    ...
    storyTitle: 'قصتنا',
    storyP1: 'تأسست شركة "أنتون" من شغف بالجمالية والعملية في عالم البناء. ما بدأ كورشة صغيرة أصبح واحدة من الشركات الرائدة في حلول الألومنيوم والصلب للاستخدام السكني والصناعي.',
