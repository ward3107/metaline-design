  ...
  sections: {
    intro: {
      ...
      controller: {
        ...
        businessName: 'שם העסק: Metaline - פתרונות אלומיניום ופלדה',
        owner: 'בעלים: [שם הבעלים]',
        address: 'כתובת: רחוב המלאכה 12, אזור תעשייה חולון, ישראל',
        email: 'דוא"ל לפניות פרטיות: info@metaline.com',
        website: 'אתר: https://metaline.co.il',
      },
    ...
    rights: {
      ...
      howToExercise: 'למימוש זכויותיך, שלח דוא"ל ל: info@metaline.com עם הנושא: "בקשת זכויות פרטיות"',
  ...
  sections: {
    intro: {
      ...
      controller: {
        ...
        businessName: 'Business Name: Metaline - Aluminum & Steel Solutions',
        owner: 'Owner: [Owner Name]',
        address: 'Address: 12 HaMelacha St., Holon Industrial Zone, Israel',
        email: 'Privacy Contact Email: info@metaline.com',
        website: 'Website: https://metaline.co.il',
      },
    ...
    rights: {
      ...
      howToExercise: 'To exercise your rights, send an email to: info@metaline.com with subject: "Privacy Rights Request"',
